  ...
  return (
    <div id="top" className="min-h-screen bg-stone-50 text-slate-800">
      ...
      <header className="sticky top-0 z-50 border-b border-stone-200 bg-white/85 shadow-sm shadow-stone-200/70 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
          ...
          <nav className="hidden gap-6 text-sm font-medium text-slate-600 md:flex items-center">
            <a href="#about"   className="transition hover:text-[#4f6b3c]">{t.nav.about}</a>
            <a href="#board"   className="transition hover:text-[#4f6b3c]">{t.nav.board}</a>
            <a href="#blog"    className="transition hover:text-[#4f6b3c]">{t.nav.blog}</a>
            <a href="#gallery" className="transition hover:text-[#4f6b3c]">{t.nav.gallery}</a>
        ...
        {menuOpen && (
          <div className="border-t border-stone-200 bg-white/95 px-6 py-4 md:hidden">
            <nav className="flex flex-col gap-4 text-sm font-medium text-slate-700">
              <a href="#about"   onClick={() => setMenuOpen(false)} className="transition hover:text-[#4f6b3c]">{t.nav.about}</a>
              <a href="#board"   onClick={() => setMenuOpen(false)} className="transition hover:text-[#4f6b3c]">{t.nav.board}</a>
              <a href="#blog"    onClick={() => setMenuOpen(false)} className="transition hover:text-[#4f6b3c]">{t.nav.blog}</a>
              <a href="#gallery" onClick={() => setMenuOpen(false)} className="transition hover:text-[#4f6b3c]">{t.nav.gallery}</a>
      ...
      <main>
        ...
        {/* HERO */}
        <section className="relative overflow-hidden bg-gradient-to-b from-[#faf7f0] via-[#fcfbf8] to-[#f2eee2]">
          <div className="absolute inset-0 opacity-40">
            <div className="absolute -left-20 top-10 h-72 w-72 rounded-full bg-[#dce5cf] blur-3xl" />
            <div className="absolute right-0 top-24 h-80 w-80 rounded-full bg-[#e8dec8] blur-3xl" />
          </div>
          ...
          <div className="relative mx-auto grid max-w-7xl gap-14 px-6 py-20 lg:grid-cols-[1.25fr_0.75fr] lg:px-10 lg:py-28">
            ...
            <div className="flex flex-col">
              <div className="mb-5 inline-flex self-start items-center gap-2 rounded-full border border-[#d7dfcc] bg-white/80 px-4 py-2 text-sm text-[#4f6b3c] shadow-sm shadow-stone-200/70">
                <span className="h-2 w-2 rounded-full bg-[#4f6b3c]" />
                {t.hero.badge}
              </div>
              ...
              <div className="mt-auto flex flex-wrap gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 rounded-2xl bg-[#4f6b3c] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-stone-300/50 transition hover:bg-[#435933]"
                >
                  <LinkedInIcon />
                  {t.hero.ctaLinkedIn}
                </a>
                <a
                  href="#board"
                  className="rounded-2xl border border-[#d7dfcc] bg-white px-6 py-3 text-sm font-semibold text-slate-800 shadow-sm shadow-stone-200/70 transition hover:border-[#9aaa86] hover:bg-[#f3efe4]"
                >
                  {t.hero.ctaBoard}
                </a>
                <a
                  href="#about"
                  className="rounded-2xl border border-stone-200 bg-stone-100 px-6 py-3 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-[#9aaa86] hover:bg-white hover:text-[#4f6b3c]"
                >
                  {t.hero.ctaAbout}
                </a>
              </div>
            ...
            <div className="flex items-end">
              <div className="w-full rounded-[2rem] border border-white/80 bg-white/85 p-6 shadow-xl shadow-stone-200/80 backdrop-blur-xl">
                <div className="mb-5 flex justify-center">
                  <div className="relative h-36 w-36 overflow-hidden rounded-full ring-4 ring-[#e6ebdb] shadow-lg shadow-stone-200/80">
                    <Image
                      src={profileImage}
                ...
                <div className="mb-5 flex items-center justify-between">
                  ...
                  <div className="rounded-full bg-[#eef2e6] px-3 py-1 text-xs font-semibold text-[#4f6b3c]">
                    {t.hero.profileBadge}
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  {t.hero.profileLines.map((line) => (
                    <div key={line} className="flex items-start gap-3 rounded-2xl border border-[#d7dfcc] bg-[#f6f3ea] p-4">
                      <div className="mt-1 h-2.5 w-2.5 shrink-0 rounded-full bg-gradient-to-r from-[#4f6b3c] to-[#8a9b6e]" />
...
<section id="about" className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
  <div className="grid gap-14 lg:grid-cols-[1fr_1.6fr]">
    ...
    <div className="flex flex-col gap-8">
      ...
      {/* Portrait */}
      <div className="group relative overflow-hidden rounded-[1.75rem] border border-stone-200 bg-white shadow-xl shadow-stone-200/80">
        ...
        <div className="absolute bottom-0 left-0 right-0 flex items-center gap-3 px-5 py-4">
          <div className="h-2 w-2 rounded-full bg-[#4f6b3c]" />
...
<div className="flex flex-col justify-center space-y-5 text-lg leading-8 text-slate-600">
  ...
  <p className="font-medium text-slate-800">{t.about.closing}</p>
        ...
        {/* BOARD CONTRIBUTIONS */}
        <section id="board" className="bg-[#f5f1e8] py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-10">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {boardContributions.map((item) => (
                <div
                  key={item.title}
                  className="group rounded-[1.75rem] border border-stone-200 bg-white p-7 shadow-sm shadow-stone-200/70 transition hover:-translate-y-1 hover:border-[#9aaa86] hover:shadow-xl hover:shadow-stone-300/80"
                >
                  <div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-[#4f6b3c] to-[#8a9b6e] text-xl text-white">
                    {item.icon}
                  </div>
        ...
        <section id="blog" className="bg-white py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-10">
            ...
            <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
              ...
              <button onClick={() => setConnectOpen(true)} className="text-sm font-semibold text-[#4f6b3c] transition hover:text-[#435933]">
                {t.blog.connect}
              </button>
            </div>

            {/* Authenticity note */}
            <div className="mb-12 flex items-start gap-3 rounded-2xl border border-[#d7dfcc] bg-[#f6f3ea] px-5 py-4">
            ...
            {visibleBlogPosts.length > 0 ? (
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {visibleBlogPosts.map((post) => (
                  <Link
                    ...
                    className="group flex flex-col rounded-[1.75rem] border border-stone-200 bg-white p-7 shadow-sm shadow-stone-200/70 transition hover:-translate-y-1 hover:border-[#9aaa86] hover:shadow-xl hover:shadow-stone-300/80"
                  >
                    ...
                    <h3 className="mb-3 text-lg font-semibold leading-snug text-slate-900 transition group-hover:text-[#4f6b3c]">
                    ...
                    <div className="text-sm font-semibold text-[#4f6b3c] transition group-hover:text-[#435933]">
                      {t.blog.readPost}
                    </div>
                  </Link>
                ))}
              ...
              <div className="flex flex-col items-center justify-center rounded-[1.75rem] border border-dashed border-[#d7dfcc] bg-[#f6f3ea] px-8 py-20 text-center">
                <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-white text-2xl shadow-sm shadow-stone-200/70">
                  📝
                </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-6 rounded-2xl border border-[#d7dfcc] bg-white px-5 py-2.5 text-sm font-semibold text-slate-700 transition hover:border-[#9aaa86] hover:text-[#4f6b3c]"
                >
        ...
        {/* GALLERY */}
        <section id="gallery" className="bg-[#f3efe4] py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-10">
                ...
                {professionalImages
                  ...
                  .map((img) => (
                    <button
                      ...
                      className="group relative aspect-[4/3] overflow-hidden rounded-[1.5rem] border border-stone-200 bg-white shadow-sm shadow-stone-200/70 transition hover:border-[#9aaa86] hover:shadow-xl hover:shadow-stone-300/80 focus:outline-none"
                    >
                      <Image
                        src={img.image}
                        alt={img.alt}
        ...
        <section className="bg-white py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-10">
            <div className="overflow-hidden rounded-[2rem] bg-gradient-to-r from-[#4f6b3c] via-[#708454] to-[#c3b28f] p-[1px] shadow-xl shadow-stone-300/50">
              <div className="rounded-[2rem] bg-[#f8f4ea] px-8 py-10 md:px-12 md:py-12">
                <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
                  <div>
                    <div className="mb-3 inline-block rounded-full bg-[#eef2e6] px-3 py-1 text-xs font-semibold uppercase tracking-[0.16em] text-[#4f6b3c]">
                      {t.perspective.label}
                    </div>
                    <h2 className="text-3xl font-bold tracking-tight text-slate-900 md:text-4xl">
                  ...
                  <div>
                    <button
                      ...
                      className="inline-flex rounded-2xl bg-[#4f6b3c] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#435933]"
                    >
                      {t.perspective.cta}
                    </button>
                  </div>
      ...
      <footer className="border-t border-stone-200 bg-white">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-12 lg:grid-cols-[1fr_auto] lg:px-10">
          ...
          <div className="grid gap-3 text-sm text-slate-500">
            <button
              onClick={() => setConnectOpen(true)}
              className="inline-flex items-center gap-2 text-left transition hover:text-[#4f6b3c]"
            >
              <MailIcon />
              {t.nav.contact}
            </button>
            ...
            <a href="mailto:nh@egebjerg.it" className="inline-flex items-center gap-2 transition hover:text-[#4f6b3c]">
              <MailIcon />
              {t.footer.email}
            </a>
            <a href="#top" className="inline-flex items-center gap-2 transition hover:text-[#4f6b3c]">
              <ArrowUpIcon />
              {t.footer.backToTop}
            </a>
          </div>
          ...
          <div className="relative z-10 w-full max-w-lg rounded-[2rem] border border-stone-200 bg-white/95 p-8 shadow-2xl shadow-stone-300/60 backdrop-blur-2xl md:p-10">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-1 items-center justify-center gap-2.5 rounded-xl bg-[#4f6b3c] px-5 py-3.5 text-sm font-semibold text-white shadow-lg shadow-stone-300/50 transition hover:bg-[#435933] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#4f6b3c]"
              >
                <LinkedInIcon />
                {t.connect.linkedin}
              </a>
              <a
                ...
                className="flex flex-1 items-center justify-center gap-2.5 rounded-xl border border-[#d7dfcc] bg-[#f5f1e8] px-5 py-3.5 text-sm font-semibold text-[#4f6b3c] transition hover:border-[#9aaa86] hover:bg-[#ece5d6] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#4f6b3c]"
              >
                <MailIcon />
                {t.connect.email}
              </a>
